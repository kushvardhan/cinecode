  ...
  const values = [
    {
      title: 'Innovation',
      description:
        'We push boundaries and embrace cutting-edge technologies to deliver next-level solutions.',
      icon: '💡',
    },
    {
      title: 'Quality',
      description:
        'Every pixel, every line of code, every frame - crafted with meticulous attention to detail.',
      icon: '⭐',
    },
    {
      title: 'Collaboration',
      description:
        'We work closely with our clients, turning their vision into reality through partnership.',
      icon: '🤝',
    },
    {
      title: 'Creativity',
        ...
        <section className="py-32 px-4 md:px-8 max-w-5xl mx-auto text-center">
          <FadeInUp>
            ...
            <p className="text-xl text-gray-300 leading-relaxed">
              ...
              crafting digital experiences that feel like cinema.
            </p>
          </FadeInUp>
        </section>
        ...
        <section className="py-20 px-4 md:px-8 max-w-4xl mx-auto">
          <FadeInUp>
            ...
            <div className="space-y-4 text-gray-300 leading-relaxed">
              ...
              <p>
                Our team brings together expertise in web development, app development, UI/UX
                design, video editing, digital marketing, and SEO. We don&apos;t just build websites
                and apps - we craft experiences that tell stories, evoke emotions, and drive
                results.
              </p>
              <p>
                Every project is an opportunity to push boundaries, experiment with new
                technologies, and create something truly exceptional. From startups to established
                brands, we help our clients stand out in the digital landscape.
              </p>
            </div>
          </FadeInUp>
        </section>

// Premium Clerk sign-in page with cinematic background
import { SignIn } from '@clerk/nextjs'
import type { Metadata } from 'next'

export const metadata: Metadata = {
  title: 'Sign In - CineCode',
  description: 'Sign in to your CineCode account',
}
...
export default function SignInPage() {
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-black">
      ...
      {/* Gradient Orbs */}
      <div className="absolute top-1/4 -left-48 w-96 h-96 bg-accent-gold/20 rounded-full blur-[128px] animate-pulse" />
      ...
      <div className="relative z-10 w-full max-w-md px-4">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold mb-3 bg-linear-to-r from-(--accent-gold) to-(--accent-cyan) bg-clip-text text-transparent">
            Welcome Back
          </h1>
          <p className="text-gray-400">Sign in to continue to CineCode</p>
        </div>
          ...
          <SignIn
            appearance={{
              elements: {
                ...
                formButtonPrimary: 'bg-linear-to-r from-(--accent-gold) to-(--accent-cyan) hover:opacity-90',
